...
-- yayinlandi istemci tarafında okuduğu için (supabase.js cvFromDb) ve
-- görünüm zaten true olanları süzdüğü için listeye gerek — ama sessiz tuzak
-- (istemci varsayılan false alacak) karşısında açık olması iyi.
