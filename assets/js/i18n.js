...
(function () {
  ...
  var DICT = {
    tr: {
      ...
      "cat.link": "Havuza Git",
      "concept.eyebrow": "Yaklaşımımız", "concept.title": "Anlık çözüm değil, <span class=\"accent\">kendi kurye havuzun.</span>",
      "concept.p1": "Nasıl bir işletme her gün güvenebileceği sabit bir usta arıyorsa, kurye ihtiyacı da öyledir: Her seferinde sıfırdan kurye aramak yerine, tanıdığın ve güvendiğin kuryelerden oluşan kendi havuzunu kurarsın.",
      "concept.p2": "Kuryemi Bul; işletmelerin sürdürülebilir, güvenilir ve büyüyen bir kurye ağı oluşturmasını sağlar. Kuryeler için kalıcı iş ilişkileri, firmalar için kurumsal hacim demektir.",
      "concept.li1": "Güvenilir kuryelerle uzun vadeli çalış",
      "concept.li2": "Bölgesel ve sürdürülebilir kurye ağı",
      "concept.li3": "Tek platformda teklif, iletişim ve yönetim",
      "concept.quote": "Sabit döner ustanı nasıl seçiyorsan, sabit kuryeni de öyle seç.",
      "concept.by": "— Kuryemi Bul yaklaşımı",
    ...
    en: {
      ...
      "cat.link": "Go to Pool",
      "concept.eyebrow": "Our Approach", "concept.title": "Not a quick fix — <span class=\"accent\">your own courier pool.</span>",
      "concept.p1": "Just as a business looks for a reliable, regular chef it can count on every day, courier needs are the same: instead of searching from scratch each time, you build your own pool of couriers you know and trust.",
      "concept.p2": "Kuryemi Bul lets businesses build a sustainable, reliable and growing courier network. For couriers it means lasting work relationships; for firms, corporate volume.",
      "concept.li1": "Work long-term with couriers you trust",
      "concept.li2": "A regional, sustainable courier network",
      "concept.li3": "Offers, contact and management on one platform",
      "concept.quote": "Choose your regular courier the way you choose your regular chef.",
      "concept.by": "— The Kuryemi Bul approach",
